            ...
            <div class="p-i-content">
                <el-form :model="infoForm" :rules="formRules" ref="infoForm" label-width="140px" class="p-i-form">
                    <div class="p-i-form-item clearfix">
                        <el-form-item  label="所属单位：" class="p-i-form-item-content"  prop="deptName" clearable :rules="[
                        ...
                        <el-form-item label="部门名称：" class="p-i-form-item-content" prop="name" size="small">
