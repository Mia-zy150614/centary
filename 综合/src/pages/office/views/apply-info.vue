<template>
    <div class="page-container page-info">
        <div class="p-i-section"  v-if="isEdit">
            ...
            <div class="p-i-content">
                <el-form :model="infoForm" :rules="formRules" ref="infoForm" label-width="120px" class="p-i-form">
                    ...
                    <div class="p-i-form-item clearfix">
                        <el-form-item label="请假事由：" prop="content" class="p-i-form-item-content large">
        ...
        <div v-if="!isEdit" class="apply-page">
                <table class="apply-table" border="1" style="border-collapse: collapse;" width="1000px" cellpadding="10">
                    <tr>
        ...
        data() {
            return {
                ...
                formRules: {
                    ...
                    content: [{required: true, message: '请假事由不能为空'},{ max: 100, message: '序号不能超过100个字符',trigger: 'blur'}],
                },
                leaveTypeList:[],// 请假类型
                allUserList: [], // 所有人员
                // 附件列表
