				...
				<div class="p-i-section">
					<el-tabs v-model="activeName" type="border-card">
						...
						<el-tab-pane label="详细信息" name="second"  class="p-i-content" :class="isDisable ? 'userinfo-wrap':''" >
							<el-form ref="infoForm" :model="personnelinfoForm" :rules="personnelRules" label-width="120px" :label-position="labelPosition"  style="margin-left:15px">
								...
								<div class="p-i-form-item clearfix">
									<el-form-item label="籍贯" class="p-i-form-item-content" prop="nativePlace" >
										<el-input v-model="personnelinfoForm.nativePlace" size="small" clearable v-show="!isDisable"></el-input>
										<el-link type="primary" :underline="false" v-show="isDisable">{{personnelinfoForm.nativePlace}}</el-link>
									</el-form-item>
								...
								<div class="p-i-form-item clearfix">
									<el-form-item label="健康状态"  class="p-i-form-item-content" prop="health">
										...
										<el-link type="primary"  :underline="false" v-show="isDisable">{{personnelinfoForm.healthLabel}}</el-link>
									</el-form-item>
								...
								<div class="p-i-form-item clearfix">
									<el-form-item label="头像" class="el_form_item_rest large remark" prop="head">
										<span class="personnel-head" v-show="isDisable">
											<img src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" alt="" v-if="personnelinfoForm.head == null">
											<img :src="personnelinfoForm.head" v-else>
										</span>
										<div v-show="!isDisable">
											<edit-img v-show="personnelinfoForm.head" :options="{image: personnelinfoForm.head, smallImgShow: true, imgHeight: '100px',buttonShow:true}"  @delImg='delImg'/>
											<Image2Base64 @success="getHeadImgStr" v-show="!personnelinfoForm.head">
													<el-button slot="upload-btn" size="mini" type="success">上传头像图片</el-button>
											</Image2Base64>
										</div>
									</el-form-item>
								</div>
							...
							<div class="submit-btn-warp">
								<el-button class="btn" size="small"   @click="cancel" v-if="!isDisable">取消</el-button>
								<el-button class="btn" size="small" @click="cancel"  v-if="isDisable">返回</el-button>
								<el-button class="btn" type="primary" size="small" v-if="!isDisable" :disabled="preventSecondarySubmit"  @click="saveSubmit('infoForm')">保存</el-button>
							</div>	
						</el-tab-pane>
					</el-tabs>
				</div>
