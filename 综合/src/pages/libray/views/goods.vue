<template>
    <div class="goods-page page-container">
        <div class="page-search clearfix">
            ...
            <el-popover placement="bottom-start" trigger="click" width="600" popper-class="high-search-popover" ref="high-search-popover">
                ...
                <div class="high-search-content">
                    <el-form ref="high-search-popover-form" label-width="100px" :model="searchOptionsForm" :rules="searchRules" label-position="right" class="high-search-popover-form">
            ...
            <el-button type="primary" size="mini" class="p-s-btn" @click="outerVisible = true">批量搜索</el-button>
...
export default {
    ...
    components: { ImportUploadComp , MoreSerach},
    created(){
        this.getList();
    },
    watch: {
    ...
    methods: {
        ...
        getName(data){
            if(data === false){
                ...
                if(data.radio === "1"){
                    this.searchOptionsForm.goodsName = data.content
                    this.searchOptionsForm.type=""
                }else{
                    this.searchOptionsForm.goodsName=""
                    this.searchOptionsForm.type = data.content
                }
        ...
        exportExcel() {
            ...
            this.searchOptionsForm.ids = ids.join(',')
            goodsApi.exportExcel(this.searchOptionsForm).then(res =>{}).catch(err => console.warn(err))
        },
        /* table 选择 */
        ...
        //下载模板
        downLoadTemplate(){
            goodsApi.downLoadTemplate({fileId:1}).then(res =>{}).catch(err => console.warn(err))
        },
        /* 批量导入 */
        importExcel() {
