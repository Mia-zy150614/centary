           ...
           <el-scrollbar class="scroll-wrap-bar">
                <div class="p-i-section">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-form-item prop="price" class="p-i-form-item-content">
                                                    <el-input size="mini" v-model="infoForm.price" placeholder="请输入价格" autocomplete="off"></el-input>
                                                </el-form-item>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="submit-btn-warp">
                        <el-button class="btn" type="primary" @click="submitSave('infoForm')" size="small" :disabled="preventSecondarySubmit">保存</el-button>
...
export default {
    ...
    data() {
        return {
            ...
            formRules: {
                params:{ max:500,message:'长度应在500字符以内',trigger:'blur'},//参数
                ...
                price:  {validator: this.validatePrice, trigger: 'blur' }, // 价格
