...
<template>
    <div class="margin-top-20">
        ...
        <Image2Base64 @success="selectedFile" style="visibility: hidden;height:0;" >
            <el-button slot="upload-btn" size="mini" type="success" id="inputFile"></el-button>
        </Image2Base64>
    </div>
</template>
<script>
...
import htmlTags from "./config/html-tags";
import fontSizeTable from "./config/font-size-table";
...
export default {
    ...
    methods: {
        ...
        selectedFile(imgUrl) {
            ...
            this.editor.appendHtml(`<img style="max-width:100%;" src="${imgUrl}">`);
        },
        // 编辑器内容上传到cos，调用返回url
        async content2Url() {
            console.log(0)
